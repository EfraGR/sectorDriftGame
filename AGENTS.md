# AI Agent Instructions for Hackathon ICPC: Desafío Arcade

You are helping build an arcade game for the Hackathon ICPC arcade challenge. Follow these instructions carefully.
